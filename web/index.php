...
<div class="header" id="head">	
			   ...
			   <div class="wmuSliderWrapper">
				   ...
				   <article style="position: relative; width: 100%; opacity: 1;"> 
				   	      ...
				   	      <div class="banner_center">
				   		 		...
				   		 		<h2>B.SC <span>COGNITIVE</span></h2>
				   		 		<h2>2019-2022</h2>
				   		 		</div>
				   		  </div>
				   </article>
	...
	<div class="container">
		<div class="about-header">
			...
			<div class="about-text">
					<p>This about Ashwin.P from Neyveli, and Purushing B.Sc cognitive Final year in Karpagam Academy.</p> 
					<p>Done schooling in Jawahar matric higher secondary Neyveli. </p>
					<p>In SSlC - 80%. </p>
					<P>In HSC - 64%.</P>
					<p>CGPA - 8.00</p>
			</div>
	...
	<div class="footer-section" id="contact" id="contact">
			...
			<div class="social-icon">
				<a href="https://instagram.com/itz_me_ashwin._?utm_medium=copy_link"><i class="icon2"></i></a>
				<a href="https://instagram.com/itz_me_ashwin._?utm_medium=copy_link"><i class="icon3"></i></a>
			</div>
			<div class="contact">
				<form name="frmContact" method="post" action="ashwin.php">
					<p>
